---
title: 'CARBayes Tutorial: Part 1'
date: '2019-08-04'
---
...
# workflow attempt: write in Rmd, knit to md
```

# CARBayes Tutorial: Part 1


Spatial data violates one of the most basic assumptions in statistics: that our observations are independent of one another. This means that many familiar methods -- Bayesian and frequentist! -- are insufficient for modelling spatial data. This two-part blog post will introduce Bayesian methods for modelling spatially autocorrelated data and offer a tutorial for analysis in R using the `CARBayes` package. 
